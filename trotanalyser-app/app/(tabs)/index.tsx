...
export default function ReunionsScreen() {
    ...
    try {
      ...
      const cache = localStorage.getItem("reunions_cache");
      ...
      localStorage.setItem("reunions_cache", JSON.stringify(enriched));
    } catch (e) {
      setError(String(e));
    } finally {
      setLoading(false);
  ...
  useEffect(() => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                <Text style={styles.screenTitle}>Réunions du jour
</Text>
              ...
              <View style={styles.courseHeader}>
                ...
                {typeof course.valueMax === "number" && course.valueMax >= 8 && (
                  <Text style={styles.valueBadge}>🔥 VALUE +{course.valueMax}</Text>
                )}
              </View>
