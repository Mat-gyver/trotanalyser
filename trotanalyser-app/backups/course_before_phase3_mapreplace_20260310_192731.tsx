...
import CourseHorseCard from "../components/course/CourseHorseCard";
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.headerBox}>
        <Text style={styles.courseCode}>
          {data.reunion || reunion} {data.course || course}
        </Text>
        <Text style={styles.meta}>
          {data.hippodrome || "Hippodrome"} • {data.distance || "-"} m • {data.partants || participants.length} partants
        </Text>

        <View style={styles.conditionsRow}>
          <View style={styles.conditionItem}>
            <Text style={styles.conditionIcon}>{getMeteoIcon(data.meteo)}</Text>
            <Text style={styles.conditionText}>
              {data.meteo || "Météo NR"} • {data.temperature ? `${data.temperature}°` : "NR°"}
            </Text>
          </View>

          <View style={styles.conditionItem}>
            <Text style={styles.conditionIcon}>🎏</Text>
            <Text style={styles.conditionText}>{data.vent || "NR"} km/h</Text>
          </View>

          <View style={styles.soilWrap}>
            <Text style={styles.soilLabel}>Sol : {souplesseLabel(data.souplesse)}</Text>
            <View style={styles.soilTrack}>
              <View style={[styles.soilSeg, styles.soilVerySoft]} />
              <View style={[styles.soilSeg, styles.soilSoft]} />
              <View style={[styles.soilSeg, styles.soilGood]} />
              <View style={[styles.soilSeg, styles.soilFirm]} />
              <View style={[styles.soilSeg, styles.soilVeryFirm]} />
              <View
                style={[
                  styles.soilMarker,
                  { left: `${souplesseIndex(data.souplesse) * 25}%` },
                ]}
              />
            </View>
          </View>
      ...
      <View style={styles.pronoBox}>
        <Text style={styles.blockTitle}>⭐ PRONOSTIC IA</Text>
        <Text style={styles.pronoLine}>{pronosticIa || "-"}</Text>
        <Text style={styles.pronoSub}>
          Base : {strategieConseil().base} • Outsiders : {strategieConseil().outsiders}
        </Text>
      </View>
      ...
      {sortedParticipants.map((c) => (
        <View key={String(c.numero)} style={styles.card}>
